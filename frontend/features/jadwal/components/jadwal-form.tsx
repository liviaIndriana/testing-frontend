        ...
        <CardContent className="p-6 sm:p-10 lg:p-14">
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <Label className="text-[#30418F]">Kelas</Label>
              <Input
                value={form.kelas}
                onChange={(e) =>
              ...
              />
              {errors.kelas && (
                <p className="text-xs text-red-500">{errors.kelas}</p>
              )}
            </div>

            {/* Tanggal */}
            <div className="flex flex-col gap-2">
              <Label className="text-[#30418F]">Tanggal</Label>
              <Input
                type="date"
                value={form.tanggal}
                onChange={(e) =>
            ...
            {/* Waktu Mulai */}
            <div className="flex flex-col gap-2">
              <Label className="text-[#30418F]">Waktu Mulai</Label>
              <Input
                type="time"
            ...
            <div className="flex flex-col gap-2 md:col-span-2">
              <Label className="text-[#30418F]">Ruangan</Label>
              <Input
                value={form.ruangan}
                onChange={(e) =>
